...
clear
gen country = .
save "$data/nochild_baseline_1554.dta",replace
...
qui append using "$data/nochild_baseline_1554.dta",nolabel
qui save "$data/nochild_baseline_1554.dta",replace
}


use "$data/nochild_baseline_1554.dta",clear
