...
clear
gen country = .
save "$data/nochild_fertility_1554.dta",replace
...
qui append using "$data/nochild_fertility_1554.dta",nolabel
qui save "$data/nochild_fertility_1554.dta",replace
}

use "$data/nochild_fertility_1554.dta",clear
...
save "$data/nochild_fertility_merge_1554.dta",replace
