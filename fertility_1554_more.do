...
* Author: Paul W Dai
* Update: Aug 21, 2021
* Purpose: Corr. Childlessness and Fertility
********************************************************************************
...
clear
gen country = .
save "$data/nochild_fertility_1554_more.dta",replace
...
qui capture collapse (mean) chborn nochild [aw=perwt], by(country year sample)
qui append using "$data/nochild_fertility_1554_more.dta",nolabel
qui save "$data/nochild_fertility_1554_more.dta",replace
}

use "$data/nochild_fertility_1554_more.dta",clear
...
keep country year countrycode sample chborn nochild gdppc lngdp



save "$data/nochild_fertility_merge_1554_more.dta",replace
