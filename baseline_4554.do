...
clear
gen country = .
save "$data/nochild_baseline_4554.dta",replace
...
// age
qui capture keep if age>=45 & age<=54 // age near the end of fertility
// education
...
qui append using "$data/nochild_baseline_4554.dta",nolabel
qui save "$data/nochild_baseline_4554.dta",replace
}


use "$data/nochild_baseline_4554.dta",clear
...
save "$data/nochild_baseline_merge_4554.dta",replace
